# TerraFirmaGreg: Modern - Veles PlayGame (Season 5)

Официальный сайт для сервера Minecraft **TerraFirmaGreg: Modern** (Сезон 05, v0.12.7) от проекта [Veles PlayGame].
...
- **Информация о сезоне**: Краткое описание тематики сборки (реалистичное выживание TerraFirmaCraft, геология, индустриализация GregTech Modern, квестовая цепочка).
